...
#SBATCH --qos=rtx_qos
#SBATCH --output=/projects/net_contrast_classification/jobs/deep_class/contrast_3d_%A.out
#SBATCH --error=/projects/net_contrast_classification/jobs/deep_class/contrast_3d_%A.err
